  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      <div className="absolute top-6 left-6 z-20">
        <a href="/" className="inline-flex h-10 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-muted text-muted-foreground hover:text-foreground px-4 py-2 gap-2">
      ...
      <Card className="glass-card relative z-10 w-full max-w-md border-black/10 dark:border-white/10 p-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 bg-black/5 dark:bg-white/5 border-black/10 dark:border-white/10 focus:border-violet-500/50 transition-colors"
              />
            </div>
            <div className="space-y-2">
